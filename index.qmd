...
*Rendered with [Quarto](https://quarto.org/). Analysis conducted with R using the following packages:  `htmltools`  `kableExtra` `knitr`  `plotly` `scales`  `sessioninfo` `tidyverse`*
